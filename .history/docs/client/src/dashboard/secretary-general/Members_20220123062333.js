...
const Members = () => {
    ...
    const [displayCards, setShowCardResults] = useState(false);
    ...
    const toggleTableDisplay = () => {
        if(showResults.displayTable) {
            setShowResults(showResults.displayTable = true);
            console.log(showResults.displayTable);
            console.log(showTable);
        }
        else {
            setShowResults(showResults.displayTable = false);
            console.log(showResults.displayTable);
        }
