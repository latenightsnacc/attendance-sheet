                ...
                <div className="container text-gray-800">
                    ...
                    <div className="flex flex-row justify-between">
                        ...
                        <div className="flex flex-row">
                            ...
                            <button className="my-1 mr-1 lg:mr-2 inline-block px-3 py-2 rounded  tracking-wide text-gray-800 bg-gray-100 bg-opacity-50 hover:bg-green-100 text-xs text-left md:text-right md:text-sm capitalize shadow-sm flex items-center" onClick={showTabk}>Table View</button>
                        </div>
                        
                    </div>
                </div>
                <div>
                {displayCards? memberslist.map((val,key) => {
                        return <Card 
                            name={val.name} 
