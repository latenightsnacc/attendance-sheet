    ...
    return(
        <>
            ...
            <div class="flex justify-center">
                <a href="../minutes/new.html" class="no-underline mx-2">
                    <span 
                    ><span><i class="fas fa-plus"></i></span><span class="hidden md: ml-1 md:inline-block">New</span></span>
                </a>
                
                <a href="view-attendance.html" class="no-underline mx-2">
                    <span 
                    class="my-1 mr-1 lg:mr-2 inline-block px-3 py-2 rounded  tracking-wide text-gray-800 bg-gray-100 bg-opacity-50 hover:bg-green-100 text-xs text-left md:text-right md:text-sm capitalize shadow-sm flex items-center"><span><i class="far fa-eye"></i></span><span class="hidden md: ml-1 md:inline-block">View All</span></span>
                </a>
                ...
                <div class="h-4"></div>
                    ...
                    <div className="flex flex-row">
                        <span>Total: 170</span>
                        <button className="className="my-1 mr-1 lg:mr-2 inline-block px-3 py-2 rounded  tracking-wide text-gray-800 bg-gray-100 bg-opacity-50 hover:bg-green-100 text-xs text-left md:text-right md:text-sm capitalize shadow-sm flex items-center"" onClick={toggleCardDisplay}>Card view</button>
                        <button onClick={toggleTableDisplay}>Table View</button>
                    </div>
                </div>
                <div>
