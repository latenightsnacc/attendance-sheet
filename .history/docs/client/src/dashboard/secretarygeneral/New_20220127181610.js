...
const New = () => {
    ...
    return(
        ...
        <div className="w-full md:w-5/6 md:mx-auto">
            ...
            <div className="mx-7">
                <form>
                <div className="flex flex-row items-center justify-between text-sm te">
                        <div>
                            ...
                            className="border-1 w-32 py-2 px-3 my-2 focus:outline-none" />
                        </div>
                        <div className="ml-2">
                    ...
                    id="venue"
                    placeholder="Venue" 
                    className="border-1 w-full py-2 px-3 my-2 focus:outline-none" />
                    <input 
                    type="text"
                    name="topic"
                    id="topic"
                    ...
                    id="minutes"
                    type="text"
                    className="border-1 w-full h-96 p-3 focus:outline-none"></textarea>
                    <SpacerSm />
