        ...
        <div className="w-full md:w-5/6 md:mx-auto">
            ...
            <div className="ml-7">
                <form>
                    ...
                    <button className="h-10 w-32 inline-block px-3 py-2 rounded  tracking-wide text-gray-800 bg-gray-100 bg-opacity-50 hover:bg-green-100 text-xs text-left md:text-right md:text-sm capitalize shadow-sm flex items-center">Save</button>
