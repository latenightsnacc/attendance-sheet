    ...
    return(
        ...
        <div className="w-full md:w-5/6 md:mx-auto">
            <div className="container text-gray-800">
                ...
                <Spacer />
                <div className="m-auto md:w-4/6 w-fullflex flex-row items-center justify-between">
            ...
            <div className="m-auto md:w-4/6 w-full">
                ...
                <div className="flex flex-row items-center justify-between text-sm text-gray-700">
                    ...
                    <div className="flex flex-row items-center">
                        <label for="venue" className="mr-2">Venue:</label>
                        <input 
                        type="text"
                        name="venue"
                        id="venue"
                        placeholder="Venue" 
                        className="border-1 rounded w-96 py-2 px-3 my-2 focus:outline-none" />
                    </div>
