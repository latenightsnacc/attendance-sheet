        ...
        <div className="w-full md:w-5/6 md:mx-auto">
            ...
            <div className="m-auto md:w-4/6 w-full">
                <form className="text-sm text-gray-700">
                    ...
                    <SpacerSm />
                    <button className="w-full inline-block py-2 rounded tracking-wide text-gray-800 bg-gray-100 bg-opacity-50 hover:bg-green-100 capitalize hover:shadow-sm flex ">Save </button>
