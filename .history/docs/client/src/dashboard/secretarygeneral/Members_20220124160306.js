                ...
                <div className="container text-gray-800">
                    ...
                    <h1 className="font-semibold text-3xl ml-5 ">List of ICT Members</h1>
                        ...
                        <div className="flex flex-row">
                            <button className="my-1 h-12  mr-1 lg:mr-2 inline-block px-3 py-2 rounded  tracking-wide text-gray-800 bg-gray-100 bg-opacity-50 hover:bg-green-100 text-xs text-left md:text-right md:text-sm capitalize shadow-sm flex items-center" onClick={showCards}>Card view</button>
                            <button className="my-1 h-12  mr-1 lg:mr-2 inline-block px-3 py-2 rounded  tracking-wide text-gray-800 bg-gray-100 bg-opacity-50 hover:bg-green-100 text-xs text-left md:text-right md:text-sm capitalize shadow-sm flex items-center" onClick={showTable}>Table View</button>
                        </div>
