...
const New = () => {
    ...
    const [details, setDetails] = useState({
      ...
      const createNew = async () => {
        ...
        formData.append('startTime', details.name);
        formData.append('endTime', details.email);
        formData.append('venue', details.phone);
        formData.append('topic', details.state);
        formData.append('minutes', details.statecode);
        formData.append('type', details.batch);
        try {
